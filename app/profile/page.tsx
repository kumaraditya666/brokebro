      ...
      <Card className="mt-4 text-center">
        ...
        <div className="mt-3 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-8">
          <div className="flex items-center gap-3">
            <span className="font-display text-lg font-extrabold">Aditya</span>
            <a href="https://www.instagram.com/aadiiii___666" target="_blank" rel="noopener noreferrer" className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-bold text-lime-200/80 transition hover:border-lime-300/40 hover:text-lime-200">
              📸 @aadiiii___666
            </a>
          </div>
          <div className="flex items-center gap-3">
            <span className="font-display text-lg font-extrabold">Atharv</span>
            <a href="https://www.instagram.com/atharvvarshney7" target="_blank" rel="noopener noreferrer" className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-bold text-lime-200/80 transition hover:border-lime-300/40 hover:text-lime-200">
              📸 @atharvvarshney7
            </a>
          </div>
        </div>
